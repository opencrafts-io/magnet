...
class _FinancialTransaction extends FinancialTransaction {
  const _FinancialTransaction({@JsonKey(name: "transaction_id") required this.transactionId, @JsonKey(name: "amount") required this.amount, @JsonKey(name: "date") this.date, @JsonKey(name: "transaction_type") this.transactionType, @JsonKey(name: "payment_method") this.paymentMethod, @JsonKey(name: "student_id") required this.studentId, @JsonKey(name: "description") this.description, @JsonKey(name: "balance_after_transaction") required this.balanceAfterTransaction, @JsonKey(name: "status") this.status, @JsonKey(name: "transaction_reference") this.transactionReference, @JsonKey(name: "category") this.category, @JsonKey(name: "currency") this.currency = "KES", @JsonKey(name: "processed_by") this.processedBy}): super._();
